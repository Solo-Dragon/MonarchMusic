...
from MonarchMusic.Helpers.active import add_active_chat, is_active_chat, stream_on
from MonarchMusic.Helpers.downloaders import audio_dl
from MonarchMusic.Helpers.errors import DurationLimitError
from MonarchMusic.Helpers.gets import get_file_name, get_url
from MonarchMusic.Helpers.inline import buttons
from MonarchMusic.Helpers.queue import put
from MonarchMusic.Helpers.thumbnails import gen_qthumb, gen_thumb
...
async def play(_, message: Message):
    ...
    if await is_active_chat(message.chat.id):
        ...
        position = len(monarchdb.get(message.chat.id))
