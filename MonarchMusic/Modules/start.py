...
import config
from MonarchMusic import BOT_MENTION, BOT_NAME, app
from MonarchMusic.Helpers import gp_buttons, pm_buttons
from MonarchMusic.Helpers.dossier import *


@app.on_message(filters.command(["start"]) & ~filters.forwarded)
@app.on_edited_message(filters.command(["start"]) & ~filters.forwarded)
async def monarch_st(_, message: Message):
