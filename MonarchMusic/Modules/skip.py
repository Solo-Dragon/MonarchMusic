...
from MonarchMusic import BOT_USERNAME, app, monarchdb, pytgcalls
from MonarchMusic.Helpers import _clear_, admin_check, buttons, close_key, gen_thumb
...
async def skip_str(_, message: Message):
    try:
        ...
        pass
    get = monarchdb.get(message.chat.id)
    if not get:
        try:
